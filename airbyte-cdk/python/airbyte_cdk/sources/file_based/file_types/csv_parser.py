...
class CsvParser(FileTypeParser):
    ...
    def _to_nullable(
        ...
        get_none = CsvParser._value_is_none

        return {k: None if get_none(v, deduped_property_types.get(k), null_values_set, strings_can_be_null) else v for k, v in row.items()}
