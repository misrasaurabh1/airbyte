...
class CsvParser(FileTypeParser):
    ...
    def _to_nullable(
        ...
        _value_is_none = CsvParser._value_is_none  # Local reference for faster access
        nullable = {
            k: None if _value_is_none(v, deduped_property_types.get(k), null_values, strings_can_be_null) else v for k, v in row.items()
        }
        return nullable
