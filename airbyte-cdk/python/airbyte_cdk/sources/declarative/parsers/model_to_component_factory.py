...
class ModelToComponentFactory:
    ...
    def _check_if_plain_string(self) -> bool:
        evaluated = self._interpolation.eval(self.string, {}, self.default, parameters=self._parameters)
        return self.string == evaluated
