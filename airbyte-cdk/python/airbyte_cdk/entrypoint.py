...
class AirbyteEntrypoint(object):
    ...
    def parse_args(args: List[str]) -> argparse.Namespace:
        ...
        # create a common function to add config argument
        ...
        add_config_argument(check_parser.add_argument_group("required named arguments"))

        # discover
        discover_parser = subparsers.add_parser(
            "discover", help="outputs a catalog describing the source's schema", parents=[parent_parser]
        )
        add_config_argument(discover_parser.add_argument_group("required named arguments"))
        ...
        add_config_argument(required_read_parser)
    ...
    def extract_state(cls, args: List[str]) -> Optional[Any]:
        ...
        return getattr(parsed_args, "state", None)
